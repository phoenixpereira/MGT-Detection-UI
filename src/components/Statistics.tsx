...
const Statistics: React.FunctionComponent<StatisticsProps> = ({ userText }) => {
      ...
      const createCharts = () => {
            createChart(
                  ...
                  calculateLexicalDiversity(userText) * 17.5 // Pass userText to calculate lexical diversity
            );
            createChart(
                  ...
                  calculateAvgSentenceLength(userText) * 0.15 // Pass userText to calculate average sentence length
            );
      };
                                         ...
                                         y: {
                                               ...
                                               suggestedMin:
                                                     title === "Average Sentence Length"
                                                           ? 0
                                                           : undefined, // Set suggestedMin based on the chart title
                                               suggestedMax:
                                                     title === "Average Sentence Length" ? 100 : 1 // Set suggestedMax based on the chart title
                                         }
                                   },
                                   plugins: {
                                         title: {
